...
import edu.cnm.deepdive.codebreaker.app.service.respository.GameSummaryRepository;
...
public class SummaryViewModel extends ViewModel {
  ...
  SummaryViewModel(@ApplicationContext Context context, GameSummaryRepository repository) {
    ...
    poolSize = new MutableLiveData<>(); // FIXME: 3/11/2026 Take initial values from prefs/resources
    codeLength = new MutableLiveData<>();// FIXME: 3/11/2026 Take initial values from prefs/resources
